...
function Bookings() {
    ...
    // var bookingsurl="http://localhost:8080/customer"

    var fetchbookings = "http://localhost:8080/bookings";
    ...
    var rendersampleTable = () => {
        return book_details.map(item=> {
            ...
            return (
				...
				<div className="table-data">{start_date}</div>
				<div className="table-data">{end_date}</div>
				<div className="table-data">{amount}</div>
